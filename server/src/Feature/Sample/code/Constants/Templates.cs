namespace MockProject.Feature.Sample.Constants
{
    public class Templates
    {
        ...
        {
            public const string TemplateId = "{79FE5626-B885-4242-BEB8-DACDF090F254}";
        ...
        {
            public const string TemplateId = "{E7FE18CB-6089-4305-96A8-DB60BEF31063}";

            public static class Fields
            {
                public const string Logo = "{F849EF60-02AE-48D7-B575-2BA24F6E544D}";
                public const string Weather = "{7A82A3CB-5A74-4AEB-B1AB-DA118297D4C7}";
                public const string WebName = "{739671DB-2129-4FDC-8A9C-895C8239AF66}";
                public const string MainNavigation = "{AFAB5BB8-8F12-4218-84E4-8BAAF2D83D12}";
            }
        }

        public static class Category
        {
            public const string TemplateId = "{E8C88A55-472C-4769-8F3C-B77126156AF1}";
        ...
        {
            public const string TemplateId = "{0155E9D0-59CD-43AA-A473-22B3B33F595C}";
        ...
        public static class Slidebar
        {
            public const string TemplateId = "{A5CA10DE-10C0-47C5-A090-CF0BEAA56921}";

            public static class Fields
            {
                public const string Images = "{385148C0-5E12-410B-81E7-BFB9267A9464}";
            }
        }
